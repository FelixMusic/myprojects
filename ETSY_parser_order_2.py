...
for i in range(1, 217): # 216 страниц
    url = 'https://www.etsy.com/shop/NikkiPattern/reviews?ref=pagination&page=' + str(i)
...
# Добавляем лист
sheet = book.add_sheet('NikkiPattern')
...
book.save('Shop1_NikkiPattern.xls')  # Сохраняем в файл
